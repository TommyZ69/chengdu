...
if __name__ == "__main__":
    ...
    tasks = [
        # 医疗：剔除宠物相关小类
        {"filename": "医疗_12975.xlsx", "category": "medical", "noise_subs": ['兽医站', '宠物诊所', '动物医疗场所', '医疗保健用品', '医疗保健服务场所']},
        
        # 餐饮：剔除无实际意义的餐饮相关
        {"filename": "餐饮_61102.xlsx", "category": "catering", "noise_subs": ['餐饮相关']},
        
        # 购物：剔除所有家居、建材、五金等低频购物小类
        {"filename": "购物_102215.xlsx", "category": "shopping", 
         "noise_subs": ['家具城', '家具建材综合市场', '家居建材市场', '建材五金市场', '厨卫市场', '布艺市场', '灯具瓷器市场']},
        
        # 金融：核心修正！剔除保险、证券、财务机构，只留银行和ATM
        {"filename": "金融服务_7158.xlsx", "category": "finance", 
         "noise_subs": ['保险公司', '金融保险机构', '证券公司', '证券营业厅', '财务公司']},
        
        # 科教文化：剔除驾校
        {"filename": "科教文化_10917.xlsx", "category": "edu", "noise_subs": ['驾校']},
        
        # 生活服务：剔除中介、搬家、丧葬
        {"filename": "生活服务_54730.xlsx", "category": "life", 
         "noise_subs": ['中介机构', '搬家公司', '丧葬设施', '公墓', '陵园']},
        
        # 体育休闲：全部保留
        {"filename": "体育_6754.xlsx", "category": "sports", "noise_subs": None},
        
        # 政府：剔除外国机构
        {"filename": "政府_6960.xlsx", "category": "government", 
         "noise_subs": ['外国使领馆', '国际组织办事处', '外国机构相关', '行业协会', '社会团体相关', '政府及社会团体相关', '公证鉴定机构']}
    ]
